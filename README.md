...
Food establishments are expected to maintain A grades. That’s why you typically see an “A” in most restaurants. In fact, when SNHD downgrades from A, the operators have just a couple weeks to rectify problems before a re-inspection. 

But locations don’t have to show you their grades from last month or even yesterday, and that’s where Safe Eats gives you the full picture. With Safe Eats, you’ll be able to see their history of inspections, including details about what exactly has gone wrong.
...
<img width="150" alt="grade_badge" src="https://github.com/user-attachments/assets/037c1112-5d86-403f-b875-6e3bca99059a" align="right" /> For each list entry you’ll see a badge showing the current grade for the location. An A grade is shown in green, a B is yellow, and a C is orange. Occasionally you’ll also see X grades in red, which indicate that the location was closed by SNHD for major violations. 
...
For easier access to locations you visit often, swipe right in the list and tap Favorite. You can use the same process to un-favorite a location. 

### Get Notifications 
To get a notification when a location's grade changes or whenever they're inspected, swipe right in the list and tap Notify.  You can use the same process to turn a locations' notifications off. 

You can pick the notifications you care about in Settings. You can also tell Safe Eats to notify you when things change at any of the locations you've marked as favorites. 

### Sharing Locations
To share details about a location, including its name, address, and a brief inspection report, swipe right and tap Share. 

## Digging Into the Details
Tap on any entry in the list to see details about the location. There’s lots to see here, broken down into several sections. 
...
### Safe Eats Insights
Since some violations are more significant than others, the app gives you a way to see the a location's inspection history from a bird's eye view in the Safe Eats Insights section. Here, you can see exactly how many time signicant issues have occured over the last 5 or 10 inspections, or even over the location's entire history. 

With Safe Eats Insights it's easy to see a restaurant has had repeatedly had the same issues come up, and whether those issues are highly significant (like food wholesomeness) or more administrative in nature (like not displaying grade cards consistently).

As in Inspection History, you can tap to drill down into more information about violation types and specific violations.

### Location
Displays a map of the establishment's location. You can zoom in or out of the map using the pinch gesture. Tap on the map to instantly get driving directions from Apple Maps.
